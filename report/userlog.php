...
<div class="card-body">
	<div>
		<div style="padding-bottom: 5px; padding-top: 5px; display: table-row;">	   
		  ...
		  <button class="btn bg-primary " onclick="exportTableToCSV('user-log-surf-<?= $filedownload; ?>.csv')" title="Download user log"><i class="fa fa-download"></i> CSV</button>
